...
class Roombooking:
    def __init__(self,root):
        ...
        conn = mysql.connector.connect(host="localhost",username="root",password="Munai@2001",database="management",auth_plugin='mysql_native_password')
        ...
        ############## RIGHT SIDE IMAGE ################
        img3 = Image.open(r"C:\Users\shyam\Desktop\DESKTOP\_FILES\ANALYTICS PROJECT\HOTEL-MANAGEMENT-SYSTEM-main\images\room1.jpg")
        ...
        combo_search["value"]=("CONTACT","ROOM_AVAILABLE")
