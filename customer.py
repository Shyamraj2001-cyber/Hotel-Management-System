...
class Cust_Win:
    def __init__(self,root):
        ...
        self.Cust_details_table=ttk.Treeview(details_table,columns=("Ref","Name","Mother","Gender","Postcode","Mobile","Email","Nationality","Idproof","Idnumber","Address"),xscrollcommand=Scroll_x.set,yscrollcommand=Scroll_y.set)
        ...
        self.Cust_details_table.heading("Postcode",text="POST")
