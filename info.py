...
class Info_details:
    def __init__(self,root):
        ...
        ##################  info ###########################
        img3 = Image.open(r"C:\Users\shyam\Desktop\DESKTOP\_FILES\ANALYTICS PROJECT\HOTEL-MANAGEMENT-SYSTEM-main\images\REPORTS.png")
        img3 = img3.resize((1100,417),Image.Resampling.LANCZOS)
