...
class Login_window:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\shyam\Desktop\DESKTOP\_FILES\ANALYTICS PROJECT\HOTEL-MANAGEMENT-SYSTEM-main\images\login_background.jpg")
        ...
        img1=Image.open(r"C:\Users\shyam\Desktop\DESKTOP\_FILES\ANALYTICS PROJECT\HOTEL-MANAGEMENT-SYSTEM-main\images\login_icon.ico")
        ...
        ########## ICON IMAGES ###############
        img2=Image.open(r"C:\Users\shyam\Desktop\DESKTOP\_FILES\ANALYTICS PROJECT\HOTEL-MANAGEMENT-SYSTEM-main\images\login_icon.ico")
        img2=img2.resize((25,25),Image.Resampling.LANCZOS)
        self.photoimage2=ImageTk.PhotoImage(img2)
        lblimg2=Label(image=self.photoimage2,bg="black",borderwidth=0)
        lblimg2.place(x=510,y=306,width=25,height=25)

        img3=Image.open(r"C:\Users\shyam\Desktop\DESKTOP\_FILES\ANALYTICS PROJECT\HOTEL-MANAGEMENT-SYSTEM-main\images\password_icon.ico")
    ...
    def login(self):
        if self.txtuser.get()=="" or self.txtpass.get()=="":
            ...
            conn = mysql.connector.connect(host="localhost",user="root",password="Munai@2001",database="management",auth_plugin='mysql_native_password')
...
class Register:
    def __init__(self,root):
        ...
        ###### BG IMAGE ##########
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\shyam\Desktop\DESKTOP\_FILES\ANALYTICS PROJECT\HOTEL-MANAGEMENT-SYSTEM-main\images\register_background.jpg")

        bg_lbl=Label(self.root,image=self.bg)
        bg_lbl.place(x=0,y=0,relheight=1,relwidth=1)

        ########## LEFT IMAGE #############
        self.bg1=ImageTk.PhotoImage(file=r"C:\Users\shyam\Desktop\DESKTOP\_FILES\ANALYTICS PROJECT\HOTEL-MANAGEMENT-SYSTEM-main\images\register_left_background.jpg")
        ...
        ########### BUTTON #############
        img = Image.open(r"C:\Users\shyam\Desktop\DESKTOP\_FILES\ANALYTICS PROJECT\HOTEL-MANAGEMENT-SYSTEM-main\images\register_button.png")
        ...
        img1 = Image.open(r"C:\Users\shyam\Desktop\DESKTOP\_FILES\ANALYTICS PROJECT\HOTEL-MANAGEMENT-SYSTEM-main\images\login_button.png")
    ...
    def rgister_data(self):
        if self.var_fname.get()=="" or self.var_email.get()=="" or self.var_security_q.get()=="SELECT":
            ...
            if row!=None:
                ...
                my_cursor.execute("insert into register values(%s,%s,%s,%s,%s,%s,%s,%s)",(self.var_fname.get(),self.var_lname.get(),self.var_contact.get(),self.var_email.get(),self.var_security_q.get(),self.var_security_a.get(),self.var_pass.get(),self.var_confpass.get()))
                conn.commit()
                conn.close()
